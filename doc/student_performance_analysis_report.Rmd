...
```{r prepare_data}
data <- download.file("https://archive.ics.uci.edu/ml/machine-learning-databases/00257/Data_User_Modeling_Dataset_Hamdi%20Tolga%20KAHRAMAN.xls","../data/raw/student_performance.xls")
...
main_training <- function(file_path, target_value){
    ...
    user_training <- assert_data(data_training_raw, result, target_value)
...
main_testing <- function(file_path, target_value){
    ...
    result <- highest_cor(data_training_raw, target_value)
    user_testing <- assert_data(data_testing_raw, result, target_value)
    return(user_testing)
}
...
Figure \@ref(fig:peg-stg-plot) shows a scatterplot of PEG against STG.
...
knitr::include_graphics("../results/lm_regression.png.png")
```
---
...
---
```{r knn-regression-plot, out.width="50%", fig.cap = "Plot of Linear Regression"}

...
---
```{r user-means-table}
user-means-table <- read_csv("../../results/means.csv")
knitr::kable(user-means-table, caption = "Table of user means")
```
---
...
---
```{r user-maxima-table}
user-maxima-table <- read_csv("../../results/maximum.csv")
knitr::kable(user-maxima-table, caption = "Value of User maxima")
```
---
...
---
```{r user-minima-table}
user-minima-table <- read_csv("../../results/minimum.csv")
knitr::kable(user-minima-table, caption = "Value of User minima")
```
---
...
user-observations-table <- read_csv("../../results/observations.csv")
knitr::kable(user-means-table, caption = "Value of User maxima")
```
---
...
knitr::include_graphics("../../results/peg_stg.png")
```
---
...
knitr::include_graphics("../../results/lm_predictions.png")
```
---
...
---
```{r lm-rmse-table}
lm-rmse-table <- read_csv("../../results/lm_rmse.csv")
knitr::kable(user-minima-table, caption = "LM RMSE table")
```
---
...
---
```{r lm-rmspe-table}
lm-rmse-table <- read_csv("../../results/lm_rmspe.csv")
knitr::kable(user-minima-table, caption = "LM RMSPE table")
```
---
...
---
```{r knn-rmse-table}
lm-rmse-table <- read_csv("../../results/knn_rmse.csv")
knitr::kable(user-minima-table, caption = "KNN RMSE table")
```
---
...
---
```{r knn-rmspe-table}
lm-rmse-table <- read_csv("../../results/knn_rmspe.csv")
knitr::kable(user-minima-table, caption = "KNN RMSPE table")
```
---
...
knitr::include_graphics("../../results/knn_regression_plot.png")
```
---
